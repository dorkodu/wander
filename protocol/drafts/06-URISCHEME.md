...
## Wander URI scheme `wander:`

`draft` `author:doruk@dorkodu.com`

This note standardizes the usage of a common URI scheme for maximum interoperability and openness in the network.

The scheme is `wander:`.
