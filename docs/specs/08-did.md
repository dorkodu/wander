# AT Protocol DIDs[#](https://atproto.com/specs/did#at-protocol-dids)
...
## Blessed DID Methods[#](https://atproto.com/specs/did#blessed-did-methods)
...
## AT Protocol DID Identifier Syntax[#](https://atproto.com/specs/did#at-protocol-did-identifier-syntax)
...
### Examples[#](https://atproto.com/specs/did#examples)
...
## DID Documents[#](https://atproto.com/specs/did#did-documents)
...
## Public Key Encoding[#](https://atproto.com/specs/did#public-key-encoding)

The atproto cryptographic systems are described in the [AT Protocol Overview](https://atproto.com/specs/atp).
...
- ```
  ...
  (string, required): a fixed name identifying the key's curve type
...
## Usage and Implementation Guidelines[#](https://atproto.com/specs/did#usage-and-implementation-guidelines)
...
## Possible Future Changes[#](https://atproto.com/specs/did#possible-future-changes)
